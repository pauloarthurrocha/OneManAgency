...
## Referência: Playbooks Iniciais

Para ver o escopo detalhado de fases que deve ser injetado em `.planning/PIPELINE.md` para cada tipo de projeto, **SEMPRE** consulte o arquivo `references/playbooks.md`.

```markdown
# Instrução interna: 
# Leia src/skills/client-onboarding/references/playbooks.md ao preencher o PIPELINE.md
```
