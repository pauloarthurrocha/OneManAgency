...
console.log('\nPara comecar:');
console.log('  1. mkdir meu-projeto && cd meu-projeto');
console.log('  2. Abrir pasta no IDE (Claude, Cursor, OpenCode...)');
console.log('  3. skill(name="agencia-init")    # Cria estrutura do projeto');
console.log('  4. skill(name="client-onboarding") # Entrevista e gera PIPELINE.md\n');
console.log('Nota: O CLI nao cria projetos. A skill agencia-init faz isso dentro do IDE.\n');
